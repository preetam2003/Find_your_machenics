          ...
          <div className="grid md:grid-cols-4 gap-8">
            ...
            <div>
              ...
              <ul className="space-y-2">
                <li><Link to="/search" className="text-gray-600 hover:text-primary-600">Find Mechanics</Link></li>
            ...
            <div>
              ...
              <ul className="space-y-2">
                <li><Link to="/register?role=mechanic" className="text-gray-600 hover:text-primary-600">Register Shop</Link></li>
                <li><Link to="/mechanic/dashboard" className="text-gray-600 hover:text-primary-600">Dashboard</Link></li>
              </ul>
            </div>
            <div>
              <h4 className="font-semibold text-gray-900 mb-4">Support</h4>
              <ul className="space-y-2">
                <li><Link to="#" className="text-gray-600 hover:text-primary-600">Help Center</Link></li>
                <li><Link to="#" className="text-gray-600 hover:text-primary-600">Contact Us</Link></li>
              </ul>
            </div>
          </div>
